...
import com.app_perso.tutorfinder_v2.ui.forgottenPassword.ForgottenPasswordActivity;
    ...
    private void doOutcome(String outcome, User signInUser, Activity activity) {
        ...
        if (outcome.equals(SignInSignUpUtils.SIGNED_IN)) {
            ...
            switch (signInUser.getRole()) {
                case STUDENT:
                    intent = new Intent(activity, StudentMainActivity.class);
                    break;

                case TUTOR:
                    intent = new Intent(activity, TutorMainActivity.class);
                    break;
